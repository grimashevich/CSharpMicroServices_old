...
namespace MetricsAgent.Controllers
{
    ...
    public class CpuMetricsController : ControllerBase
    {
        ...
        // [x] b. api / metrics / dotnet / errors - count / from /{ fromTime}/ to /{ toTime}
        // [x] c. api / metrics / network / from /{ fromTime}/ to /{ toTime}
        // [x] d. api / metrics / hdd / left / from /{ fromTime}/ to /{ toTime}
